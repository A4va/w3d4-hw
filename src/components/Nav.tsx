  ...
  return (
      <Box pl={{sm:0 ,md:16}} mb="450px">
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          ...
          <Flex 
          borderRadius={"0 0 0 .5rem"} p={"1rem 1.75rem"} bg={useColorModeValue('gray.100', 'gray.900')} alignItems={'center'}>
            <Text cursor={"pointer"} mx={4}>
                Home
            </Text>
            <Text cursor={"pointer"} mx={4}>
                About us
            ...
            <Stack  ml={4} direction={'row'} spacing={7}>
              <Button
